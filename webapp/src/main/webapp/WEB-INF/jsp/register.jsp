...
<section>
    ...
    <form class="clearfix" method="POST" action="${process}">
        ...
        <input class="form-control" type="title" name="username" id="username-input" placeholder="${locUsernamePlaceholder}"
        ...
        <input class="form-control" type="password" name="password" id="password-input" placeholder="${locPasswordPlaceholder}"
               minlength="6"
               pattern="^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?!.*\s).*$"
               title="Must contain at least one letter in uppercase and lowercase and digit"
               required/>
        <input class="form-control" type="password" placeholder="${locPasswordRepeatPlaceholder}" id="password-repeat-input"
               oninput="checkpassword()"
               minlength="6" required/>

        <label for="birthday-input">${locBirthday}:</label>
        <input class="form-control" type="date" name="birthday" id="birthday-input" onchange="validateBirthday(this)"
               required>
        ...
        <input class="form-control" type="title" name="firstName" id="first-name-input" placeholder="${locFirstName}"
               required>

        <label for="last-name-input">${locLastName}:</label>
        <input class="form-control" type="title" name="lastName" id="last-name-input" placeholder="${locLastName}" required/>
